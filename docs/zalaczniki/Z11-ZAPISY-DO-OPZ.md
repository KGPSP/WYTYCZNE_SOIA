...
<!-- Generated from zalaczniki/Z11-ZAPISY-DO-OPZ.md; run python scripts/sync_pages.py. -->
...
Klasa I obejmuje wspólny rdzeń. I + 1.5 jest profilem kompaktowym z lokalnym audio; I + II profilem rozszerzonym. III dodaje lokalny TTS, także do 1.5, przy zachowaniu właściwej liczby I/O. Zasoby głosu nie zwiększają automatycznie liczby styków. Wiążąca jest [macierz Z3](Z3-WYMAGANIA-MINIMALNE.md#macierz-wyposazenia).
