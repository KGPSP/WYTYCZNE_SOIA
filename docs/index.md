...
description: "Projekt zasad podłączania syren alarmowych i innych urządzeń do SOiA"
author: "Biuro Informatyki i Łączności Komendy Głównej Państwowej Straży Pożarnej"
date: 2026-08-23
version: "0.4"
status: "PROJEKT — do uzgodnienia i podpisu"
---
...
<div class="publication-status" role="status" aria-label="Status dokumentu">
  <strong>PROJEKT — dokument niepodpisany i nieobowiązujący</strong>
  <span>Wersja 0.4 do uzgodnienia i podpisu</span>
</div>
...
!!! warning "Status dokumentu"
    ...
    **Wersja 0.4 — projekt do uzgodnienia i podpisu.** Dokument nie został podpisany i nie obowiązuje.
    Niniejszy plik stanowi wariant redakcyjny V2 i nie zastępuje dokumentów źródłowych.

!!! danger "Weryfikacja przed podpisaniem"

    Redakcja V2 porządkuje język, nagłówki i sposób prezentacji. Nie stanowi potwierdzenia aktualności
    podstaw prawnych, statusu systemu, wartości operacyjnych ani założeń technicznych. Elementy te
    wymagają weryfikacji w źródłach właściwych dla dnia podpisania.
